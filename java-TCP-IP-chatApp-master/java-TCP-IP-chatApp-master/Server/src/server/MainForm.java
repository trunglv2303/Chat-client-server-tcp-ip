...
public class MainForm extends javax.swing.JFrame {
	...
	public Socket getClientList(String client) {
	    ...
	    // Lặp qua danh sách clientList
	    for (int x = 0; x < clientList.size(); x++) {
	        // Kiểm tra nếu tên client trong danh sách bằng với tên client cần tìm
	        if (clientList.get(x).equals(client)) {
	            // Nếu có, lấy socket tương ứng từ socketList
	            tsoc = (Socket) socketList.get(x);
	            break;  // Dừng vòng lặp vì đã tìm thấy client và socket tương ứng
	        }
	    }
	    
	    // Trả về socket tìm thấy (hoặc null nếu không tìm thấy)
	    return tsoc;
	}
				...
				.addGroup(layout.createSequentialGroup().addContainerGap()
						.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								...
								.addGroup(layout.createSequentialGroup().addComponent(jLabel1)
										...
										.addComponent(jTextField1, javax.swing.GroupLayout.PREFERRED_SIZE, 86,
	...
	private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton1ActionPerformed
		...
		// tạo đối tượng ServerThread với số port và Giao diện main 
